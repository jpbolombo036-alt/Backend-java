...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.itaccess.exception.ResourceNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleNotFound(com.itaccess.exception.ResourceNotFoundException ex) {
